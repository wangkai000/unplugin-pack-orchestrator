...
**English** | [简体中文](https://github.com/wangkai000/unplugin-pack-orchestrator/blob/main/README.md)

> A universal pack, compress, and archive plugin based on [unplugin](https://github.com/unjs/unplugin) for **Vite**, **Webpack**, **Rollup**, and **ESBuild**. Generates **ZIP** / **TAR** / **TAR.GZ** / **7Z** archive/compress files with zero runtime dependencies. Automatically computes checksums (MD5/SHA1/SHA256) after build, and supports auto-renaming archives via the `onAfterBuild` hook (e.g., appending hash or version) for traceable artifacts.
